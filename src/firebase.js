...
const firebaseConfig = {
  ...
  authDomain: getCleanEnv(import.meta.env.VITE_FIREBASE_AUTH_DOMAIN) || "link-x-6606e.firebaseapp.com",
  projectId: "link-x-6606e",
  storageBucket: getCleanEnv(import.meta.env.VITE_FIREBASE_STORAGE_BUCKET) || "link-x-6606e.firebasestorage.app",
