...
import { Sparkles, ArrowRight, Check, ShoppingCart, Truck, Database, Printer, Heart, Monitor } from 'lucide-react';
...
const Hero = ({ onOpenInquiry, onOpenInstall }) => {
          ...
          <div className="w-full flex flex-col items-center gap-6">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <button 
                ...
                className="group relative inline-flex items-center justify-center gap-3 bg-slate-900/90 hover:bg-slate-850 text-white font-black text-lg px-10 py-5 rounded-2xl border border-slate-700/80 hover:border-slate-650 transition-all duration-300 transform hover:-translate-y-1 shadow-[0_4px_25px_rgba(0,0,0,0.35)]"
              >
                <Monitor className="h-5 w-5 text-blue-400 group-hover:scale-110 transition-transform" />
                <span>링커엑스 설치하기</span>
              </button>
            </div>
